	...
	local settings = {
		...
		},
		{
			...
			settings = {
				...
				{
					id = "rebind_strategem_menu_1",
					ui_name = "Strategems Menu (stationary)",
					ui_description = "The keybind used to open the strategems menu.\nWill lock movement.",
					value_default = "224",
					ui_fn = ui_get_input,
					is_waiting_for_input = false,
					scope = MOD_SETTING_SCOPE_RUNTIME,
				...
				{
					id = "rebind_strategem_menu_2",
					ui_name = "Strategems Menu (unrestricted)",
					ui_description = "The keybind used to open the strategems menu.\nWon't lock movement.",
					value_default = "228",
					ui_fn = ui_get_input,
					is_waiting_for_input = false,
