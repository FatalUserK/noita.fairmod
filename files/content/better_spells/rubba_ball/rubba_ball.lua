local rubba = {
	...
	related_projectiles = { "mods/noita.fairmod/files/content/better_spells/rubba_ball/rubber_ball.xml" },
	...
	mana = 7,
	action = function()
		add_projectile("mods/noita.fairmod/files/content/better_spells/rubba_ball/rubber_ball.xml")
