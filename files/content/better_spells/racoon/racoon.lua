local pedro = {
	...
	name = "Racoon",
	description = "Racoon?",
	sprite = "mods/noita.fairmod/files/content/better_spells/racoon/icon.png",
	sprite_unidentified = "data/ui_gfx/gun_actions/disc_bullet_unidentified.png",
	related_projectiles = { "mods/noita.fairmod/files/content/better_spells/racoon/racoon.xml" },
	...
	mana = 80,
	action = function()
		add_projectile("mods/noita.fairmod/files/content/better_spells/racoon/racoon.xml")
