local spakr = {
	...
	related_projectiles = { "mods/noita.fairmod/files/content/better_spells/spakr_bolt/light_bullet.xml" },
	...
	mana = 6,
	action = function()
		add_projectile("mods/noita.fairmod/files/content/better_spells/spakr_bolt/light_bullet.xml")
