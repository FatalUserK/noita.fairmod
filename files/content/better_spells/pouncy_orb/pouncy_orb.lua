local pouncy = {
	...
	related_projectiles = { "mods/noita.fairmod/files/content/better_spells/pouncy_orb/bouncy_orb.xml" },
	...
	mana = 25,
	action = function()
		add_projectile("mods/noita.fairmod/files/content/better_spells/pouncy_orb/bouncy_orb.xml")
