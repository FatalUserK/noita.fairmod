...
local cheats = {
	...
	-- every 2 frames have 10% chance to set marker that warps player back after 10-120 frames
	-- when warping, 50% chance to leave another marker at current positio
	--lightmode
